...
public class Main{
     ...
     */
    static int i=1;
    static StringStreamer stream1 = new StringStreamer();
    ...
    public static void main(String[] args) {//main function, program start...
        ...
        JLabel txtCrudTitle = new JLabel("This is the CRUD portion of the program.");
        ...
        crudFrame.getContentPane().add(pnCrudCenter,BorderLayout.CENTER); //renderin at center
